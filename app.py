    ...
    def add_footer(self):
        ...
        with col2:
            ...
            <p style='text-align: center;'>
                ...
                <a href="https://www.linkedin.com/in/aditya-semwal-9b88601b2" target="_blank" style='text-decoration: none; color: #FFFFFF'>
                    <b>Aditya Semwal</b>
                </a>
            </p>
            """, unsafe_allow_html=True)
     ...
     "124852522.jpeg")
        ...
        st.markdown(f"""
            <div class="profile-section">
                <img src="{image_base64 if image_base64 else 'https://avatars.githubusercontent.com/u/123470933?s=400&v=4'}"
                     alt="Aditya Semwal"
                     class="profile-image"
                     onerror="this.onerror=null; this.src='https://avatars.githubusercontent.com/u/123470933?s=400&v=4';">
                <h2 class="profile-name">Aditya Semwal</h2>
                <p class="profile-title">FQA Tester | Ensuring Smooth Gameplay & Immersive Experiences</p>
                <div class="social-links">
                    <a href="https://github.com/adityasemwal888" class="social-link" target="_blank">
                        <i class="fab fa-github"></i>
                    </a>
                    <a href="https://www.linkedin.com/in/aditya-semwal-9b88601b2" class="social-link" target="_blank">
                        <i class="fab fa-linkedin"></i>
                    </a>
                    <a href="mailto:adityasemwal888@gmail.com" class="social-link" target="_blank">
                        <i class="fas fa-envelope"></i>
                    </a>
                </div>
                <p class="bio-text">
                   Enthusiastic Computer Science student passionate about exploring diverse applications in the field. Driven by curiosity and perseverance, I strive to deepen my understanding of computer systems and their workings.
                </p>
            </div>
        """, unsafe_allow_html=True)
        ...
        st.markdown("""
            <div class="vision-section">
                ...
                <p class="vision-text">
                    "The AI Resume Analyzer is Designed to help create the most appropriate resume for your desired job role.
